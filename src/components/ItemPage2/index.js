...
class ItemPage2Base extends Component{
    constructor(props){
        super(props);
    ...
    handleSearchResultsChange(itemsList) {
    ...
    render(){
        ...
        return(
            ...
            <div>
                <h3>Items Page 2</h3>
                <SearchBar />
                <MyFilter onSearchResultsChange={this.handleSearchResultsChange}/>
...
const Items = withFirebase(ItemPage2Base)
